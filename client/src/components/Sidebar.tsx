...
const SOCIALS = [
  { 
    label: "GitHub", 
    href: "https://github.com/MierzwaMatheus", 
    icon: Github 
  },
  { 
    label: "LinkedIn", 
    href: "https://www.linkedin.com/in/matheus-mierzwa/", 
    icon: Linkedin 
  },
  { 
    label: "Behance", 
    href: "https://www.behance.net/mierzwamatheus", 
    ...
    <div className="flex flex-col h-full bg-black border-r border-white/10 w-full">
      ...
      <div className="flex flex-col items-center pt-8 pb-6 px-6">
        <div className="relative h-28 w-28 rounded-full mb-4 overflow-hidden border-2 border-neon-purple group cursor-pointer">
          ...
          <img 
            src="https://i.postimg.cc/6pWwxrLf/IMG-20220823-232153-2.jpg" 
            alt="Matheus Mierzwa" 
            className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-110"
          />
        </div>
        
        <h1 className="font-bold text-xl text-white mb-3">Matheus Mierzwa</h1>
        ...
        <div className="w-full rounded-lg bg-white/5 border border-white/5 flex items-center justify-center px-4 py-3 backdrop-blur-sm">
          <div className="text-xs text-center text-gray-400">
            ...
            <div className="text-white/90 font-medium">Front-End Developer</div>
      ...
      <div className="mt-auto px-6 py-6 border-t border-white/10 bg-black/50">
        <div className="mb-6 space-y-3">
          ...
          <a href="mailto:mierzwa.oliveira@gmail.com" className="flex items-center text-xs text-gray-400 hover:text-neon-lime transition-colors group">
            <Mail className="mr-2 h-3 w-3 text-gray-600 group-hover:text-neon-lime transition-colors" />
            <span className="truncate">mierzwa.oliveira@gmail.com</span>
          </a>
          
          <a href="https://wa.me/5511988232537" className="flex items-center text-xs text-gray-400 hover:text-neon-lime transition-colors group">
    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 h-16 bg-black/90 backdrop-blur-md border-b border-white/10 z-50 flex items-center justify-between px-4 lg:hidden">
        <div className="flex items-center">
          ...
          <span className="font-bold text-white text-sm">Matheus Mierzwa</span>
        </div>
