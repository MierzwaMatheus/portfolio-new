...
export default function Resume() {
  ...
  return (
    <>
      <SEO
        title="Currículo"
        description="Minha trajetória profissional, formação acadêmica, habilidades técnicas e certificações em desenvolvimento de software."
        url="/curriculo"
      />
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        >
          ...
          <p className="text-xl text-gray-400">{t("resume.subtitle")}</p>
        </motion.div>
                    ...
                    : softSkills.map((item, index) => {
                        ...
                        return (
                          ...
                          >
                            <Badge
                              variant="outline"
                              className="border-neon-purple/50 text-gray-300 hover:bg-neon-purple/10 transition-colors py-1 px-3"
                            >
                              {content.text}
                            </Badge>
                          </motion.div>
